        ...
        {filteredSuppliers.map((sup) => (
          <div key={sup.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all group overflow-hidden">
            ...
            <div className="bg-gray-50 px-6 py-3 border-t border-gray-100 flex items-center justify-between">
              <span className="text-xs text-gray-400">Contacto: <span className="text-gray-700 font-bold">{sup.contact_person}</span></span>
              <button className="text-xs text-green-600 font-bold hover:underline">Historial</button>
            </div>
          </div>
        ))}
      </div>
